...
> **Бизнес-правило (обновлено 2026-03-01):** Компенсация (кешбек/возврат) предлагается **только для негативных отзывов (1-3★)**. Для 4★ — стратегия исключительно повышение оценки до 5★, без денежной компенсации. AI-контекст автоматически блокирует упоминание компенсации для 4★+ отзывов (проверка `review_rating` через `review_chat_links`).
