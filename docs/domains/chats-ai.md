...
## Обогащённый контекст AI (v3.6, 2026-03-04)
...
|----------|------|:----------:|
| Web generate-ai | `stores/[storeId]/chats/[chatId]/generate-ai/route.ts` | ✅ (обновлено v3.6: seller context + OZON trim) |
| TG generate-ai | `telegram/chats/[chatId]/generate-ai/route.ts` | ✅ |
| Bulk generate-ai | `stores/[storeId]/chats/bulk/generate-ai/route.ts` | ✅ (обновлено v3.6: seller context + vendor code) |
