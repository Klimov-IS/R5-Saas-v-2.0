...
```
docs/
├── README.md                   # Навигационный индекс (START HERE)
├── _rules/                     # Политики (этот файл)
│
├── *.md                        # Операционные гайды (CRON, DB, Deploy...)
│   ├── database-schema.md      # Source of Truth — БД
│   ├── CRON_JOBS.md            # Source of Truth — Cron
│   ├── DEPLOYMENT.md           # Source of Truth — Деплой
│   └── QUICK_REFERENCE.md      # Шпаргалка
│
├── domains/                    # Доменная логика (бизнес-правила)
│   ├── complaints.md, chats-ai.md, auto-sequences.md...
│   └── wb-work-policy.md, ozon-work-policy.md
│
├── reference/                  # Техническая справка
│   ├── api.md, ARCHITECTURE.md
│   ├── EXTENSION_API_COMPLETE.md
│   └── statuses-reference.md
│
├── product/                    # Продуктовая документация
├── product-specs/              # Feature specs (планирование)
├── decisions/                  # ADRs (architecture decision records)
├── plans/                      # Architecture reviews, refactor plans, backlogs
├── sprints/                    # Спринты (Sprint-001..005)
├── tasks/                      # Задачи (+ tasks/Completed/)
├── reports/                    # Отчёты аудитов
│
└── archive/                    # Исторические документы (НЕ использовать)
```
