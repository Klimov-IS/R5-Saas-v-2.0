...
export function BulkActionsPanel({ storeId, className }: BulkActionsPanelProps) {
  ...
  return (
    <div
      className={cn(
        'absolute bottom-0 left-0 right-0 bg-gradient-to-r from-blue-500 to-purple-600 p-4 flex items-center justify-between gap-4 shadow-lg z-50 animate-slide-up',
        className
      )}
    >
