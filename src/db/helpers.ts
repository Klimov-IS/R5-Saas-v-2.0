...
// Split into 3 fast queries instead of 1 heavy combined query (avoids 60s statement_timeout)

const PRODUCTS_PROGRESS_SQL = `
SELECT
  p.store_id,
...
const DIALOGUES_PROGRESS_SQL = `
WITH chat_products AS (
  SELECT p.id AS product_id, p.store_id,
